...
const int sharp[15][8] =          //组成图形的各个点的各个坐标，先纵后横
{
    ...
    {0,0, 0,1, 0,2, 0,3}, // ----           4
    {0,0, 1,0, 0,1, 1,1}, // 田              2
    {0,0, 1,0, 1,1, 1,2}, // 水平L       3
    {0,1, 1,1, 2,0, 2,1}, // 竖直L       2
    {0,0, 0,1, 0,2, 1,2}, //水平L        3                                             
    {0,0, 0,1, 1,0, 2,0}, //竖直L        2
    {1,0, 1,1, 1,2, 0,2}, //水平L        3
    {0,0, 0,1, 1,1, 2,1}, //竖直L        2
    {0,0, 0,1, 0,2, 1,0}, //水平L        3
    {0,0, 1,0, 2,0, 2,1}, //竖直L        2
    {0,0, 0,1, 1,1, 1,2}, //水平Z        3
    {0,1, 1,0, 1,1, 2,0}, //竖直Z        2
    {0,1, 0,2, 1,0, 1,1}, //水平Z        3
    {0,0, 1,0, 1,1, 2,1}  //竖直Z        2
};
